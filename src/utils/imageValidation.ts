...
// Configuración por defecto - alineada con requerimientos reales del cliente
const DEFAULT_CONFIG: ImageValidationConfig = {
  maxFileSize: 5 * 1024 * 1024, // 5MB
  minWidth: 640, // Reducido de 800 para ser más práctico
  minHeight: 480, // Reducido de 600 para ser más práctico  
