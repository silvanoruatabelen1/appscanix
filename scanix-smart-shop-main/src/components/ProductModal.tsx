    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            {isEditing 
              ? 'Modifica los datos del producto. Los precios escalonados se configuran aparte.' 
              : 'Completa la información básica del producto. Luego podrás configurar precios por volumen.'}
          </DialogDescription>
        </DialogHeader>
