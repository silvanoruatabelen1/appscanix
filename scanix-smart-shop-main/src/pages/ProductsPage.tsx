        ...
        {products.length === 0 && !isLoading ? (
          ...
          <thead className="bg-muted/50">
            <tr>
              ...
              <th className="px-4 py-3 text-center">Descuentos por Volumen</th>
          ...
          <tbody>
            {products.map((product) => (
              <tr key={product.productId} className="border-t border-border hover:bg-accent/50">
                ...
                <td className="px-4 py-3 text-right">${(product.precioBase || 0).toFixed(2)}</td>
                <td className="px-4 py-3 text-center">
                  {product.tiers?.length > 0 
                    ? <span className="text-green-600 font-medium">{product.tiers.length} configurados ✓</span>
                ...
                <td className="px-4 py-3">
                  <div className="flex justify-center gap-1">
                    ...
                    <Button 
                      ...
                      title="Configurar precios por volumen (descuentos)"
